...
export const WEAPONS = {
  knife: {
    ...
    base: {
      dmg: [8, 9, 11, 12, 14], cd: [1.1, 1.0, 0.95, 0.88, 0.78], n: [3, 4, 5, 6, 7],
  ...
  wand: {
    ...
    base: { dmg: [16, 18, 20, 23, 26], cd: [1.25, 1.15, 1.05, 0.95, 0.85], n: [1, 2, 3, 3, 4], home: [3.2, 4.2, 5.2, 6.4, 7.6], spd: [330, 345, 360, 390, 430] },
  ...
  bow: {
    ...
    base: { dmg: [34, 38, 43, 49, 54], cd: [1.5, 1.4, 1.3, 1.2, 1.05], pierce: [1, 3, 5, 7, 9], spd: [680, 700, 725, 750, 780], life: [1.5, 1.55, 1.6, 1.65, 1.7], kb: [1, 1.1, 1.2, 1.35, 1.5] },
  ...
  orb: {
    ...
    base: { dmg: [12, 14, 15, 16, 19], cd: [0, 0, 0, 0, 0], n: [1, 2, 3, 4, 5], r: [64, 74, 84, 94, 104], spin: [3.2, 3.5, 3.8, 4.1, 4.5] },
  ...
  lightning: {
    ...
    base: { dmg: [27, 31, 35, 39, 45], cd: [2.1, 1.9, 1.75, 1.55, 1.35], n: [1, 2, 3, 4, 5], R: [440, 460, 485, 515, 555], chainN: [0, 0, 2, 2, 3], chainR: 130 },
  ...
  fireball: {
    ...
    base: { dmg: [24, 27, 30, 34, 38], cd: [1.7, 1.6, 1.5, 1.4, 1.25], boomR: [48, 60, 74, 90, 110], burnHit: [3, 3.5, 4, 4.5, 5], spd: [300, 312, 324, 336, 350] },
  ...
  boomerang: {
    ...
    base: { dmg: [22, 24, 27, 30, 34], cd: [1.8, 1.7, 1.6, 1.5, 1.35], n: [1, 2, 2, 3, 4], spd: [440, 470, 500, 540, 580], r: [11, 12, 13, 14, 16] },
  ...
  holy: {
    ...
    base: { tick: [8, 9, 11, 12, 14], cd: [2.5, 2.4, 2.3, 2.2, 2.0], n: [1, 2, 2, 3, 3], r: [54, 64, 76, 90, 106], dur: [2.6, 3.0, 3.5, 4.0, 4.6] },
  ...
  shield: {
    ...
    base: { dmg: [19, 22, 24, 27, 31], cd: [3.4, 3.1, 2.8, 2.5, 2.2], maxR: [150, 180, 214, 252, 294], kb: [1, 1.1, 1.2, 1.3, 1.45] },
  ...
  fan: {
    ...
    base: { dmg: [18, 20, 23, 27, 31], cd: [1.7, 1.55, 1.4, 1.25, 1.1], n: [3, 4, 5, 6, 7], spread: [0.5, 0.58, 0.66, 0.75, 0.84], spd: [480, 500, 525, 550, 580], life: [1.15, 1.2, 1.25, 1.3, 1.4], pierce: [0, 0, 1, 1, 2] },
  ...
  needle: {
    ...
    base: { dmg: [11, 12, 14, 16, 19], cd: [1.35, 1.22, 1.1, 0.98, 0.86], n: [5, 6, 7, 8, 9], spread: [0.7, 0.78, 0.86, 0.94, 1.02], spd: [560, 580, 600, 625, 650], life: [1.25, 1.3, 1.35, 1.4, 1.45], pierce: [0, 0, 0, 1, 1] },
  ...
  lantern: {
    ...
    desc: '放出青灯悬于敌阵,魂火持续灼魂',
    base: { dmg: [7, 8, 9, 11, 14], cd: [2.4, 2.2, 2.0, 1.8, 1.6], n: [1, 1, 2, 2, 3], r: [58, 66, 74, 84, 94], dur: [2.4, 2.8, 3.2, 3.6, 4.0], tick: [0.38, 0.36, 0.34, 0.32, 0.3], spd: [240, 250, 260, 270, 280] },
...
const EVO = {
  knife:     { n: 10, r: 132, spin: 8.2, dmg: 108, hitCd: 0.3, kb: 175 }, // 十剑环身:环绕单敌 86/0.3≈287/s
  wand:      { n: 4, cd: 0.25, dmg: 90, spd: 470, home: 9.5, life: 1.9 }, // 四连弹幕,更快更黏
  bow:       { cd: 0.8, dmg: 235, spd: 1040, r: 20, life: 1.8, kbMult: 3.6 }, // 巨箭更巨更快更远
  orb:       { n: 7, r: 132, spin: 5.4, dmg: 82, hitCd: 0.42, kb: 90, splashR: 96, splashMult: 0.6 }, // 七珠+墨爆扩大
  lightning: { n: 9, cd: 1.22, dmg: 135, chainN: 4, chainR: 160, chainMult: 0.55 }, // 连锁 +1、连锁半径扩大
  fireball:  { cd: 1.05, dmg: 144, spd: 360, boomR: 185, boomMult: 1.0, zoneR: 112, zoneDur: 3.6, zoneTick: 16 }, // 超爆+火海更广更久
  boomerang: { n: 4, cd: 1.05, dmg: 120, spd: 610, r: 18, retMult: 2 }, // 四枚巨刃
  holy:      { r: 185, dmg: 58, tick: 0.32 }, // 墨域大扩 + 跳伤更频
  shield:    { cd: 0.95, dmg: 102, maxR: 300, grow: 520, zapCd: 0.18, zapMult: 0.5, zapN: 3 }, // 钟域更大,环缘放电 3 敌

  fan:       { n: 9, cd: 0.8, dmg: 52, spread: 1.15, spd: 650, life: 1.55, pierce: 3 },
  needle:    { n: 13, cd: 0.52, dmg: 38, spread: 1.25, spd: 760, life: 1.7, pierce: 2 },
  lantern:   { n: 4, cd: 1.15, dmg: 22, r: 132, dur: 5.4, tick: 0.22, spd: 330 },
